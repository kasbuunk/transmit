...
namespace Transmit\HealthCheckResponse;

use UnexpectedValueException;

/**
 * Protobuf type <code>transmit.HealthCheckResponse.ServingStatus</code>
 */
class ServingStatus
{
    /**
...
class_alias(ServingStatus::class, \Transmit\HealthCheckResponse_ServingStatus::class);
